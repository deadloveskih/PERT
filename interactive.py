...
def help() -> None:
    ...
    print("\tadd record in csv files and cache", end="\n\n")
    print("del command")
    print("\tusing: del 'task_name'", end="\n\n")
    print("\tdelete record from csv files and cache", end="\n\n")
    print("print command")
    print("\tusing: print 'task_name'", end="\n\n")
    print("\tprint values of one task from cache", end="\n\n")
    print("show command")
    print("\tusing: show", end="\n\n")
    print("\tloads data from csv to cache and print values of all tasks from cache", end="\n\n")
    print("summarize command")
    print("\tusing: summarize", end="\n\n")
    print("\tprint summarize time and deviation of all tasks", end="\n\n")

def intercative() -> None:
